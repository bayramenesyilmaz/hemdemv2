const tr = {
  ...
  profile: {
    ...
    verifiedBadgeLabel: "Doğrulanmış profil",
    verifyTitle: "Profil Doğrulama",
    verifyCta: "Profilini Doğrula",
    verifyExplainer:
      "Profilinin gerçek olduğunu göstermek için kameranla bir selfie çek. Ekibimiz inceleyip onaylayacak.",
    verifyPendingNotice: "Doğrulama isteğin inceleniyor.",
    verifyRejectedNotice: "Doğrulama isteğin reddedildi. Tekrar deneyebilirsin.",
    verifyApprovedNotice: "Profilin doğrulandı.",
    verifyUploading: "Yükleniyor…",
    verifyErrorAlreadySubmitted: "Doğrulama isteğin zaten inceleniyor.",
    genderLabel: "Cinsiyet",
  ...
  tests: {
    ...
    errors: {
      ...
      inappropriate_content: "Başlık veya sorularda yasaklı kelime(ler) tespit edildi: ({words}).",
  ...
  messages: {
    ...
    newMessageToast: "💬 Yeni bir mesajın var",
    ...
    errors: {
      ...
      inappropriate_content: "Bu kelime(ler) yasaklı: ({words}). Mesajını düzenleyip tekrar dene.",
    },
  },
  posts: {
    title: "Gönderiler",
    ...
    errors: {
      ...
      too_many_questions: "Bir testte en fazla 10 soru olabilir.",
      too_many_options: "Bir soruda en fazla 4 şık olabilir.",
      inappropriate_content: "İçerikte yasaklı kelime(ler) tespit edildi: ({words}).",
      invalid_category: "Geçersiz kategori.",
      category_required: "Kategori seçmelisin.",
  ...
  admin: {
    ...
    verificationsLink: "Doğrulamalar",
    ...
    pendingVerificationsEmptyTitle: "Onay bekleyen doğrulama yok",
    pendingVerificationsEmptyBody: "Yeni bir kullanıcı doğrulama isteği gönderdiğinde burada görünecek.",
