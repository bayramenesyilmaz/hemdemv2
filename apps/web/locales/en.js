const en = {
  ...
  tests: {
    ...
    errors: {
      ...
      inappropriate_content: "Disallowed word(s) detected in the title or questions: ({words}).",
  ...
  messages: {
    ...
    errors: {
      ...
      inappropriate_content: "These word(s) are not allowed: ({words}). Please edit your message and try again.",
    },
  },
  posts: {
    title: "Posts",
    ...
    errors: {
      ...
      too_many_questions: "A test can have at most 10 questions.",
      too_many_options: "A question can have at most 4 options.",
      inappropriate_content: "Disallowed word(s) detected: ({words}).",
      invalid_category: "Invalid category.",
